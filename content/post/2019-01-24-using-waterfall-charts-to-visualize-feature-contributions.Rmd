...
- Feature contributions chart: this one is simpler. Same idea as above (also dependent on test sample $[x_1, x_2, ..., x_p]$), but plotted by ranking the numeric contributions by their proportions __relative__ to the prediction `contribution_proportion <- feature_contribution / prediction`, written below as `cont_prop <- featcont/pred`.
